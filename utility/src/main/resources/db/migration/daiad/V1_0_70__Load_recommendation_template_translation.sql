...
INSERT INTO public.recommendation_template_translation 
    ...
    (
        recommendation_template_from_name('LESS_SHOWER_TIME'),
        'es',
        'Reduce en un minut tu ducha y ahorra <h1>{annual_savings_1}</h1> litros',
        'Estás gastando un 50% más de agua en la ducha que otrοs. Reduciendo tu ducha en dos minutos puedes ahorrar <h1>{annual_savings_2}</h1> litros en un año. ¿Por qué no usar un contador en la ducha?'
    ); 
...
INSERT INTO public.recommendation_template_translation 
    ...
    (
        recommendation_template_from_name('LOWER_TEMPERATURE'),
        'es',
        'Puedes ahorrar <h1>{annual_savings_2,number,currency}</h1> si usas agua menos caliente en la ducha',
        'Estás utilizando agua más caliente que otros. ¡Reduciendo la temperatura de tu ducha en 2 grados ahorrarás <h1>{annual_savings_2,number,currency}</h1> en un año! ¿Quiéres que te lo recordemos la próxima vez que te duches?'
    ); 
...
INSERT INTO public.recommendation_template_translation 
    ...
    (
        recommendation_template_from_name('LOWER_FLOW'),
        'es',
        'Reduce el caudal de agua de tu ducha y ahorra <h1>{annual_savings}</h1> litros',
        '¡Puedes reducir un poco el caudal de tu ducha y ahorrar hasta <h1>{annual_savings}</h1> litros en un año!'
    ); 
...
INSERT INTO public.recommendation_template_translation 
    ...
    (
        recommendation_template_from_name('CHANGE_SHOWERHEAD'),
        'es',
        'Renueva el teléfono de la ducha y ahorra <h1>{annual_savings}</h1> litros',
        '¿Por qué no renovar el teléfono de la ducha con una más eficiente? Puedes ahorrar hasta <h1>{annual_savings}</h1> litros al año. Los nuevos modelos proporcionan una sensación de ducha similar pero con un menor consumo.'
    ); 
