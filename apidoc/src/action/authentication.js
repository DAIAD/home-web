/**
 * @api {post} login?application={utility} Login
 * @apiVersion 1.0.0
 * @apiName Login
 * @apiGroup Authentication
 *
 * @apiDescription Authenticate user credentials. The request content type must be set to `application/x-www-form-urlencoded`.
 *
 * @apiParam (Query String Parameters)   {String}  application   Application id. Valid values are:<br/><code>HOME</code><br/><code>UTILITY</code><br/>The value is not case sensitive.
 * 
 * @apiParam (Form Parameters)           {String}  username      User name.
 * @apiParam (Form Parameters)           {String}  password      User password.
 * @apiParam (Form Parameters)           {String}  _csrf         The CSRF token value.
 * 
 * @apiParamExample Request Example
 * POST /login?application=utility
 * 
 * username: user@daiad.eu
 * password: ***
 * _csrf: 5a78b3f1-f221-4077-861b-06005e4e0195
 *
 ...
 * @apiSuccess {String[]}   roles                   Array with the roles of the authenticated user i.e. <code>ROLE_UTILITY_ADMIN</code>. If <code>success</code> is <code>false</code> this property will be <code>undefined</code>.
 * 
 ...
 * @apiSuccess (Profile)            {Boolean}    sendMailEnabled       If <code>true</code> mails are send to the user.
 * @apiSuccess (Profile)            {Boolean}    sendMessageEnabled    If <code>true</code> messages are send to the user.
 ...
 * @apiGroup Authentication
 *
 * @apiDescription Ends user session. The request content type must be set to `application/x-www-form-urlencoded`.
 *
 * @apiParam (Form Parameters)           {String}  _csrf         The CSRF token value.
 * 
 * @apiParamExample Request Example
