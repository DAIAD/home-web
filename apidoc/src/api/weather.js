/**
 * @api {post} /v1/weather/service Get services
 * @apiVersion 0.0.1
...
/**
 * @api {post} /api/v1/weather/{service}/{utility}/{interval}/{from}/{to} Query data
 * @apiVersion 0.0.1
 * @apiName WeatherData
 * @apiGroup Weather
 * @apiPermission ROLE_USER, ROLE_ADMIN
 ...
 * 
 * @apiParamExample {json} Request Example
 * POST /api/v1/weather/aemet/alicante/hour/20160829/20160905
 * 
 * {
 *   username: "user@daiad.eu",
 *   password: "****"
