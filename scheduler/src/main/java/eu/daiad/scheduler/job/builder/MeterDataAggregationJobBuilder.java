...
import eu.daiad.scheduler.job.task.ExportGroupMemberToFileTask;
import eu.daiad.scheduler.job.task.YarnMapReduceJobTask;
import eu.daiad.scheduler.mapreduce.EnumJobMapReduceParameter;

/**
 * Initializes and submits a MapReduce job to YARN.
 */
@Component
public class MeterDataAggregationJobBuilder extends BaseJobBuilder implements IJobBuilder {
