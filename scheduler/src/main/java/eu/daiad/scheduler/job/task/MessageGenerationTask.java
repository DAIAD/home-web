...
import eu.daiad.common.service.message.IMessageGeneratorService;
import eu.daiad.scheduler.job.builder.MessageGeneratorJobBuilder;
...
public class MessageGenerationTask extends BaseTask implements StoppableTasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        try {
            ...
            eu.daiad.common.service.message.Configuration config =
                    new eu.daiad.common.service.message.Configuration();
