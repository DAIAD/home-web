...
import eu.daiad.common.model.user.DeviceMeterInfo;
import eu.daiad.common.model.user.UserInfo;
import eu.daiad.common.model.user.UserInfoCollectionResponse;
import eu.daiad.common.model.user.UserInfoResponse;
import eu.daiad.common.model.user.UserQuery;
import eu.daiad.common.model.user.UserQueryRequest;
import eu.daiad.common.model.user.UserQueryResponse;
    ...
    public RestResponse search(@AuthenticationPrincipal AuthenticatedUser user, @RequestBody UserQueryRequest request) {
        try {
            ...
            for (AccountEntity entity : result.getAccounts()) {
                ...
                for (eu.daiad.common.domain.application.DeviceEntity d : entity.getDevices()) {
