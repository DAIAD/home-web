...
import eu.daiad.common.model.device.AmphiroDeviceRegistrationRequest;
import eu.daiad.common.model.device.AmphiroDeviceRegistrationResponse;
...
import eu.daiad.common.model.device.DeviceConfigurationRequest;
import eu.daiad.common.model.device.DeviceConfigurationResponse;
import eu.daiad.common.model.device.DeviceRegistrationQuery;
import eu.daiad.common.model.device.DeviceRegistrationQueryResult;
import eu.daiad.common.model.device.DeviceRegistrationRequest;
import eu.daiad.common.model.device.DeviceRegistrationResponse;
import eu.daiad.common.model.device.DeviceResetRequest;
import eu.daiad.common.model.device.DeviceUpdateRequest;
import eu.daiad.common.model.device.NotifyConfigurationRequest;
import eu.daiad.common.model.device.ShareDeviceRequest;
import eu.daiad.common.model.device.WaterMeterDeviceRegistrationRequest;
...
public class DeviceController extends BaseRestController {
     ...
     */
    @PostMapping(value = "/api/v1/device/register")
     ...
     * @return the controller's response.
     */
    @PostMapping(value = "/api/v1/meter/register")
     ...
     * @return the devices.
     */
    @PostMapping(value = "/api/v1/device/query")
     ...
     * @return the controller's response.
     */
    @PostMapping(value = "/api/v1/device/share")
     ...
     */
    @PostMapping(value = "/api/v1/device/config")
     ...
     * @return the controller's response.
     */
    @PostMapping(value = "/api/v1/device/notify")
     ...
     * @return the controller's response.
     */
    @PostMapping(value = "/api/v1/device/reset")
     ...
     * @return the controller's response.
     */
    @PostMapping(value = "/api/v1/device/update")
