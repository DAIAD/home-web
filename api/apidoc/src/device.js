...
/**
 * @api {post} /v1/device/query Query devices
 * @apiVersion 0.0.1
 * @apiName DeviceQuery
 * @apiGroup Device
 * @apiPermission ROLE_USER
 ...
 *
 * @apiSuccess (Device) {String}     key                 Device unique key (UUID).
 * @apiSuccess (Device) {String}     type                Device type. Valid values are <code>METER</code> and <code>AMPHIRO</code>.
 * @apiSuccess (Device) {Object[]}   [properties]        Array of <code>KeyValuePair</code> objects representing device properties.
 * @apiSuccess (Device) {Number}     registeredOn        Device registration time stamp.
 *
 * @apiSuccess (KeyValuePair) {String}           key                         Key.
 * @apiSuccess (KeyValuePair) {String}           value                       Value.
 *
 * @apiSuccess (WaterMeterDevice extends Device) {String}     serial    Unique serial number.
 * @apiSuccess (WaterMeterDevice extends Device) {Object}     location  Location in GeoJSON format.
 *
 * @apiSuccess (AmphiroDevice extends Device)    {String}     name       User friendly name for the device i.e. Shower #1.
 * @apiSuccess (AmphiroDevice extends Device)    {String}     macAddress Device unique MAC address.
 * @apiSuccess (AmphiroDevice extends Device)    {String}     aesKey     Device AES key.
 *
 * @apiSuccessExample {json} Response Example
 * HTTP/1.1 200 OK
 * {
