...
public interface IBudgetRepository {
     ...
     */
    void updateSnapshot(UUID key, long snapshotId, double consumptionBefore, double consumptionAfter, DateTime updatedOn);
     ...
     * @param updatedOn update timestamp.
     */
    void updateSnapshot(UUID key, long snapshotId, DateTime updatedOn);
