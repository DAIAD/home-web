...
import eu.daiad.web.logging.CustomFactoryMethodConnectionSource;
import eu.daiad.web.model.error.ApplicationException;

@Component
public class LoggingConfigurer implements InitializingBean {

	private final String APPENDER_NAME = "PostgreSQL";

	@Value("${logging.table:log4j_message}")
	...
	public void afterPropertiesSet() throws Exception {
		ConnectionSource connectionSource = applicationContext.getBean(CustomFactoryMethodConnectionSource.class);
		...
		ColumnConfig[] columnConfigs = {
						...
						ColumnConfig.createColumnConfig(config, "exception", "%ex{full}", null, null, "false", null),
						ColumnConfig.createColumnConfig(config, "timestamp", null, null, "true", null, null) };

		// Create JDBC appender
		Appender appender = JdbcAppender.createAppender(APPENDER_NAME, null, null, connectionSource, null, tableName,
						columnConfigs);
		...
		LoggerConfig loggerConfig = LoggerConfig.createLogger("false", Level.ERROR,
						ApplicationException.class.getCanonicalName(),
