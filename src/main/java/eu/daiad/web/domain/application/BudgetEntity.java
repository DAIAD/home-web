...
import eu.daiad.web.model.query.savings.EnumBudgetDistribution;
import eu.daiad.web.model.query.savings.EnumBudgetStatus;

@Entity(name = "budget")
@Table(schema = "public", name = "budget")
@SqlResultSetMapping(name = "BudgetClusterSegmentResult", classes = { @ConstructorResult(targetClass = eu.daiad.web.domain.application.mappings.BudgetSegmentEntity.class, columns = {
