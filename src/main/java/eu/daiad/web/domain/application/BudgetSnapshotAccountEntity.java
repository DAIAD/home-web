...
@SqlResultSetMapping(name = "BudgetConsumerResult", classes = { @ConstructorResult(targetClass = eu.daiad.web.domain.application.mappings.BudgetConsumerEntity.class, columns = {
