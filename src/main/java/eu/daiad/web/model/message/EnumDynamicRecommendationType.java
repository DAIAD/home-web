...
public enum EnumDynamicRecommendationType {
    ...
    INSIGHT_B3_DAYOFWEEK_CONSUMPTION_PEAK(1108),
    INSIGHT_B3_DAYOFWEEK_CONSUMPTION_LOW(1109),
    
    INSIGHT_B4_MORE_ON_WEEKEND(1110),
    INSIGHT_B4_LESS_ON_WEEKEND(1111),
    
    INSIGHT_B5_MONTHLY_CONSUMPTION_INCR(1112),
    INSIGHT_B5_MONTHLY_CONSUMPTION_DECR(1113),
