...
public enum EnumRecommendationTemplate
{
    ...
    INSIGHT_A4_CONSUMPTION_METER_MAINLY_IN_MORNING(1000, EnumRecommendationType.INSIGHT_A4),
    INSIGHT_A4_CONSUMPTION_METER_MAINLY_IN_AFTERNOON(1001, EnumRecommendationType.INSIGHT_A4),
    INSIGHT_A4_CONSUMPTION_METER_MAINLY_IN_NIGHT(1002, EnumRecommendationType.INSIGHT_A4),
    INSIGHT_A4_CONSUMPTION_SHOWER_MAINLY_IN_MORNING(1003, EnumRecommendationType.INSIGHT_A4),
    INSIGHT_A4_CONSUMPTION_SHOWER_MAINLY_IN_AFTERNOON(1004, EnumRecommendationType.INSIGHT_A4),
    INSIGHT_A4_CONSUMPTION_SHOWER_MAINLY_IN_NIGHT(1005, EnumRecommendationType.INSIGHT_A4),
