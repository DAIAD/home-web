...
public class MessageCalculationConfiguration {
    ...
    private int staticTipInterval = DateTimeConstants.DAYS_PER_WEEK; //send static tip every 7 days
    private int aggregateComputationInterval = DateTimeConstants.DAYS_PER_WEEK;//compute aggregates every week
    ...
    public int getAggregateComputationDaysInterval() {
