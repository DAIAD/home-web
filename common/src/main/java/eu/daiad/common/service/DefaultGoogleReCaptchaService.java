...
@Service
public class DefaultGoogleReCaptchaService implements IGoogleReCaptchaService {
    ...
    public boolean validate(String remoteAddress, String response) throws ApplicationException {
        ...
        try {
            ...
            throw ApplicationException.wrap(ex, CaptchaErrorCode.CAPTCHA_SERVICE_ERROR, "Recaptcha API error.");
        }
