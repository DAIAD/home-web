...
import eu.daiad.common.model.profile.ComparisonRanking.MonthlyConsumtpion;
import eu.daiad.common.model.profile.ComparisonRanking.WaterIq;
...
public class HBaseWaterIqRepository extends AbstractHBaseRepository implements IWaterIqRepository {
    ...
    private EnumColumn getColumn(String value, boolean throwException) {
        ...
        if (type == null) {
            if (throwException) {
                throw createApplicationException(DataErrorCode.HBASE_INVALID_COLUMN)
                	.set("column", value);
            }
