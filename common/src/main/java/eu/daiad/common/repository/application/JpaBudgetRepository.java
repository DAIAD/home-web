...
import eu.daiad.common.domain.application.BudgetAccountEntity;
...
import eu.daiad.common.domain.application.SavingsPotentialAccountEntity;
...
import eu.daiad.common.model.error.BudgetErrorCode;
...
public class JpaBudgetRepository extends BaseRepository implements IBudgetRepository {
    ...
    public void updateSnapshot(
        ...
        budget.setNextUpdateOn(nextUpdateOn);
     ...
     */
    @Override
    public void updateSnapshot(UUID key, long snapshotId, DateTime updatedOn, DateTime nextUpdateOn) {
        BudgetEntity budget = getBudgetByKey(key);
