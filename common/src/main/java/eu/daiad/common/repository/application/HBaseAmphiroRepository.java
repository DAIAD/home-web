...
import eu.daiad.common.model.amphiro.SessionVersions;
...
import eu.daiad.common.model.profile.EnumRealTimeMode;
        ...
        try {
            ...
            for (int deviceIndex = 0; deviceIndex < deviceKeys.length; deviceIndex++) {
                ...
                for (int i = series.getPoints().size() - 1; i > 0; i--) {
                    eu.daiad.common.model.amphiro.AmphiroDataPoint current = (eu.daiad.common.model.amphiro.AmphiroDataPoint) series.getPoints().get(i);
                    eu.daiad.common.model.amphiro.AmphiroDataPoint previous = (eu.daiad.common.model.amphiro.AmphiroDataPoint) series.getPoints().get(i - 1);
